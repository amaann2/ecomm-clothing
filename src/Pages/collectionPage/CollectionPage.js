...
const CollectionPage = ({ data }) => {
  ...
  const filterproduct = items.filter(data => data.price < value && data.price > value - 10000)
  ...
  return <div className="collection-page">
    <div className="heading">
      ...
      <select name="price" id="price" className="dropdownlist" onChange={filter}>
        <option defaultValue selected>Filter By Price</option>
